window.onload = function () {
        ...
        if (elDatalist) {
            ...
            if (valDatalistRaw !== "") {
                if (regexCaractereInvalide.test(valDatalistRaw)) {
                    ...
                    let optionsDatalist = document.querySelectorAll("datalist option");
                    let gasit = false;
    ...
    //algoritmul Levenshtein: fara potrivire exacta la nume
    ...
    // actualizare in timp real a textului din input range pret minim
    ...
    if (butonFiltrare) {
        butonFiltrare.onclick = function () {
            ...
            let inpNume = document.getElementById("inp-nume") ? document.getElementById("inp-nume").value.trim().toLowerCase() : "";
            ...
            for (let prod of produse) {
                ...
                let numeComplete = elNume ? elNume.innerText.trim().toLowerCase() : "";
                ...
                let descriere = elDescriere ? elDescriere.innerText.trim().toLowerCase() : "";
                descriere = eliminaDiacritice(descriere); 
